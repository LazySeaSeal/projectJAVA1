...
public class  personnel extends personne {
   ...
   void terminer_pret(pret pret,Connection connection){
        try {
    ...
    void ajouter_pret(String nomlecteur, String prenomlecteur , String nomouvrage , String nomauteur , int days , Connection connection){
        try {
    ...
    void supprimer_lecteur(int id_lecteur , Connection connection){
        try {
    ...
    void ajouter_personnel(String nom , String prenom , String email , String  grade, Connection connection){
        try{
  ...
  ArrayList<ouvrage> get_ouvrages(Connection connection){
      try {
   ...
   void ajouter_ouvrage(String nomouvrage , String nomauteur , int nb , String categorie , Connection connection){
    ...
    void ajouter_lecteur(String nom,String prenom,String email, int abonn,Connection connection)
    {
        try{
